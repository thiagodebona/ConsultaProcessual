...
using ConsultaProcessualAPI.Configurations;
using ConsultaProcessualAPI.Helpers;
...
namespace ConsultaProcessualAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, DataContext context)
        {
            ...
            context.Users.Add(new User { Id = Guid.NewGuid(), Username = "admin", Password = "admin", DateRegister = DateTime.Now, Active = true });
            context.SaveChanges();
